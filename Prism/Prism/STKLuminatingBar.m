...
- (void)setLuminating:(BOOL)luminating
{
    ...
    if(_luminating) {
        ...
        [_luminatingLayer setLocations:@[@0, @1]];
        [_luminatingLayer setColors:@[(id)[[UIColor colorWithWhite:1 alpha:1] CGColor],
        ...
        [cAnim setFromValue:@[(id)[[UIColor colorWithWhite:1 alpha:0.25] CGColor],
                              (id)[[UIColor colorWithWhite:1 alpha:0.0] CGColor]]];
        [cAnim setToValue:@[ (id)[[UIColor colorWithWhite:1 alpha:.5] CGColor],
                              (id)[[UIColor colorWithWhite:1 alpha:0.0] CGColor]]];
        [cAnim setDuration:1];
